...
**Unkaos** - это мощный бесплатный трекер задач, вдохновленный функциональностью Jira и YouTrack, разработанный для команд разработки и не только. Наслаждайтесь надежным инструментом управления проектами с гибкой настройкой, доступным под лицензией Apache 2.

🌐 Официальное облачное хранилище: [http://unkaos.org](http://unkaos.org) | 📦 Установите на свой сервер: [Инструкция по установке](#📦standalone-setup)


Построенный на стабильных и современных технологиях, таких как Vue.js 3, Node.js, TypeScript и PostgreSQL, он обеспечивает комфортный пользовательский опыт, включая обновления в реальном времени с помощью WebSockets и даже искусственный интеллект для понимания запросов пользователей на естественном языке.

## 📖 Содержание

1. [📚Руководство пользователя](#📚user-guide)
    - [🧑‍💻Для участников команды](#🧑‍💻for-team-members)
      - [Задачи](#issues)
        - [Поиск задач](#finding-issues)
        - [Создание задач](#creating-issues)
        - [Работа с задачей](#working-with-an-issue)
        - [Массовые изменения и другие варианты искусственного интеллекта](#bulk-changes-and-other-ai-options)
      - [Agile доски](#agile-boards)
        - [Использование доски](#using-the-board)
        - [Создание и настройка вашей доски](#creating-and-configuring-your-board)
      - [Панели](#dashboards)
        - [Обзор панели](#dashboard-overview)
    ...
    - [🛠️Для администраторов рабочего пространства](#🛠️for-workspace-administrators)
    ...
    - [📦Независимая настройка](#📦standalone-setup)
      - [Установка](#installation)
      - [Настройки сервера](#server-configurations)
2. [💻Документация разработчика](#💻developer-documentation)
    - [Архитектура](#architecture)
    - [Содействие](#contributing)
    - [Справочник API (в процессе)](#api-reference-in-progress)
3. [📢Информация](#📢info)
    - [Новости](#news)
...
Если вас пригласили присоединиться к существующему проекту, вы должны связаться с вашим администратором. Они добавят вас в рабочее пространство, и вы получите письмо с ссылкой для входа и временным паролем, который вы сможете изменить в настройках вашего пользователя.
