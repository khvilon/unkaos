...
export default {
  ...
  mounted() {
    //this.select_tab(0)
    if (this.relation_types != undefined)
      this.relation_type = this.relation_types[0];
  ...
  methods: {
    ...
    async save_relation() {
      if (
        ...
        this.issue0_uuid == "" ||
        this.relation_type == undefined ||
        this.relation_type.uuid == null ||
        this.relation_type.uuid == ""
      ) {
        console.log(
      ...
      let options0 = {
        uuid: tools.uuidv4(),
        issue0_uuid: this.relation_type.is_reverted
          ? this.issue1_uuid
          : this.issue0_uuid,
        issue1_uuid: this.relation_type.is_reverted
          ? this.issue0_uuid
          : this.issue1_uuid,
