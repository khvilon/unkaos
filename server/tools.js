...
tools.transliterateEnToRu = function (text) { return tools.transliterate(text, tools.translitMapEnToRu); };
tools.transliterateRuToEn = function (text) { return tools.transliterate(text, tools.translitMapRuToEn); };
tools.transliterate = function (text, translitMap) {
    let result = '';
