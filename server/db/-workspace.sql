...
INSERT INTO test.users (uuid, name, login, mail, active, password, avatar) VALUES (
...
INSERT INTO test.users_to_roles (users_uuid, roles_uuid) VALUES ('ba52933b-9c25-4be5-8b8e-02bd26ba8feb', '556972a6-0370-4f00-aca2-73a477e48999');

INSERT INTO admin.workspaces (name, pass) VALUES('test', 'mypass');

create user test with encrypted password 'mypass';
