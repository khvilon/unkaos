...
INSERT INTO oboz.favourites_types (uuid, name) VALUES ('ac367512-c614-4f2a-b7d3-816018f71ad8', 'Сохраненный запрос');
INSERT INTO oboz.favourites_types (uuid, name) VALUES ('46d00448-4d13-471e-b996-070c0650c113', 'Дашборд');
INSERT INTO oboz.favourites_types (uuid, name) VALUES ('1b6832db-7d94-4423-80f2-10ed989af9f8', 'Доска');

INSERT INTO oboz.field_types (uuid, name, code) VALUES ('ba3c701d-ccdf-4af6-8ec1-d72fbb4fdc75', 'Время', 'Time');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('c001b93c-3676-4e1d-b52a-4e2008c62c45', 'Дата и время', 'Timestamp');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('a842d209-0111-4b8a-8ba6-cba191c1f4a1', 'Булево', 'Boolean');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('93d432ce-d64e-4b1d-a358-87fd5de9e3e4', 'Дата', 'Date');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('507278cc-a98e-4725-a248-7289dbbd4be1', 'Длительность', 'Duration');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('891b02c9-a559-44da-8840-6e93bf2d8d22', 'Строка', 'String');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('9d8ddcc7-a4e8-4ea8-b3d0-e7c9686abc6f', 'Текст', 'Text');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('c0c4036c-3dd2-4264-ba2e-ec7180a4d35c', 'Числовое', 'Numeric');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('d57da84f-ed1b-4596-9fb9-9d4c500af63d', 'Пользователь', 'User');
INSERT INTO oboz.field_types (uuid, name, code) VALUES ('457da84d-2d1d-3595-6fba-4d4d674af63f', 'Значение из списка', 'Select');

INSERT INTO oboz.fields (uuid, name, type_uuid, is_custom) VALUES ('c96966ea-a591-47a9-992c-0a2f6443bc80', 'Название', '891b02c9-a559-44da-8840-6e93bf2d8d22', false);
INSERT INTO oboz.fields (uuid, name, type_uuid, is_custom) VALUES ('4a095ff5-c1c4-4349-9038-e3c35a2328b9', 'Описание', '9d8ddcc7-a4e8-4ea8-b3d0-e7c9686abc6f', false);
...
INSERT INTO oboz.fields (uuid, name, type_uuid, is_custom) VALUES ('849644a4-cf93-4506-96d8-1027967ae253', 'Estimation', 'c0c4036c-3dd2-4264-ba2e-ec7180a4d35c', true);
...
INSERT INTO oboz.fields (uuid, name, type_uuid, is_custom) VALUES ('733f669a-9584-4469-a41b-544e25b8d91a', 'Автор', 'd57da84f-ed1b-4596-9fb9-9d4c500af63d', false);

INSERT INTO oboz.gadget_types (uuid, name, code) VALUES ('4a20ebc1-2740-4304-b2ea-8527f423dacd', 'Диаграмма Ганта', 'Gantt');
INSERT INTO oboz.gadget_types (uuid, name, code) VALUES ('a558d34b-0bfb-4494-bb22-40ec15e97f0a', 'Таблица задач', 'IssuesTable');
INSERT INTO oboz.gadget_types (uuid, name, code) VALUES ('4419f964-e212-4466-811e-056c1241b426', 'Отчет по затраченному времени', 'TimeReport');

INSERT INTO oboz.issue_actions_types VALUES ('1ff12964-4f5c-4be9-8fe3-f3d9a7225300', '📝');
INSERT INTO oboz.issue_actions_types VALUES ('4d7d3265-806b-492a-b6c1-636e1fa653a9', '🔁');
INSERT INTO oboz.issue_actions_types VALUES ('f53d8ecc-c26e-4909-a070-5c33e6f7a196', '💬');

INSERT INTO oboz.issue_statuses (uuid, name, is_start, is_end) VALUES ('6b0e63d5-3dcf-4c91-9f80-3c5e525c6b83', 'Новая', true, false);
INSERT INTO oboz.issue_statuses (uuid, name, is_start, is_end) VALUES ('197ae224-6990-4ba8-873d-c2aa7a63a7c5', 'В работе', false, false);
INSERT INTO oboz.issue_statuses (uuid, name, is_start, is_end) VALUES ('0f1dd8a2-159c-44cb-8254-caa8a596693b', 'Отложена', false, false);
INSERT INTO oboz.issue_statuses (uuid, name, is_start, is_end) VALUES ('f735a09b-2b0c-4541-bd3d-88ca4c27002b', 'Завершена', false, true);
INSERT INTO oboz.issue_statuses (uuid, name, is_start, is_end) VALUES ('e57cebc2-5300-47ff-8f72-5d24c5c0ac47', 'Отклонена', false, true);

INSERT INTO oboz.relation_types (uuid, name, revert_name) VALUES ('73b0a22e-4632-453d-903b-09804093ef1b', 'Родительская к', 'Дочерняя к');
INSERT INTO oboz.relation_types (uuid, name, revert_name) VALUES ('b44dab29-bd47-4507-91b1-d62ddf34d09f', 'Необходима для', 'Требуется');
INSERT INTO oboz.relation_types (uuid, name, revert_name) VALUES ('06e7ced5-d15c-412c-9e64-0858840d542d', 'Связана с', 'Связана с');
INSERT INTO oboz.relation_types (uuid, name, revert_name) VALUES ('d279639b-2a7b-44d3-b317-eceea45c5592', 'Дублирует', 'Дублируема');

INSERT INTO oboz.roles (uuid, name, is_custom) VALUES ('556972a6-0370-4f00-aca2-73a477e48999', 'Администратор', false);
